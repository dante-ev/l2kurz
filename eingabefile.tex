...
(Bericht, Buch, Brief usw.). Danach können weitere Befehle folgen bzw. deklariert werden,
die für das gesamte Dokument gelten sollen.  Dieser Teil des Dokuments wird auch als 
...
\sout{Im \local\ können weitere verfügbare Klassen angegeben sein. }\todo{MD: M.E. Raus damit}
...
\todo[inline]{MD: Jetzt sollten wir uns auf Pakete einigen. Habe schon xcolor statt color und imakeidx statt makeidx genutzt. Ich denke wenn fancyhdr angebenen ist, sollte auch scrpage2 dabei sein.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\begin{longtable}[c]{@{}>{\raggedright\arraybackslash\ttfamily}p{2.2cm}p{\dimexpr 0.95\linewidth-2.2cm-2\tabcolsep\relax}@{}}
