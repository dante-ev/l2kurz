...
ein nachfolgendes Sonderzeichen beendet wird; oder sie bestehen
aus einem Backslash und genau einem Sonderzeichen.\todo[color=done]{PG: Ziffer rausgenommen} Groß- und Kleinbuchstaben haben auch in Befehlsnamen \emph{verschiedene} 
...
\end{document}
\end{example}
\todo{PG: ich habe mal den abstract rausgenommen, der ist nicht zwingend notwendig in einer Kurzanleitung}
...
Klassen auf, die in jeder \LaTeX-Installation existieren. 
...
Optionen sind in der Tabelle~\vref{options} angeführt.
...
\todo[inline,color=done]{PG: Listing mit den hier benutzten Pakten rausgenommen}
% \begin{lstlisting}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{PG: alphabetisch sortieren? csquotes + andere dokumentieren}
\todo[inline,color=done]{fancyhdr habe ich rausgenommen, wir müssen uns beschränken}
\todo[inline,color=done]{MD: Alphabetische Sortierung -- Typisch Deutsch}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
