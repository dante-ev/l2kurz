...
\begin{tabularx}{.8\linewidth}{@{}>{\raggedright\arraybackslash\ttfamily}p{1.9cm}X@{}}
\toprule
...
sind Varianten der o.\,g. Klassen mit besserer Anpassung an DIN-Papierformate und "`europäische"' Typographie. (\cite{scrguide})\\\midrule
...
\begin{table}[hbpt]
\todo[inline]{MD: noch nicht bearbeitet}
