...
\section{Eingabedatei}

Die Eingabedatei für \LaTeX{} ist eine Textdatei, üblicherweise mit der Endung \lstinline+.tex+.
Sie wird mit einem Editor erstellt und enthält sowohl den Text, der gedruckt
