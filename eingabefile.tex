...
bspw: \href{http://tex.stackexchange.com/questions/339/latex-editors-ides}{LaTeX Editors/IDEs}}
...
aus einem Backslash und genau einem Sonderzeichen oder einer \todo{MD: Ich finde Ziffer verwirrt irgendwie?}Ziffer.
...
\todo{MD: Sollte hier ein Hinweis hin, dass Anweisungen im Header definiert werden sollten}
...
\begin{figure}[hbtp]
\todo[inline]{MD: Wirklich als float definieren? Ich würde es schöner finden, wenn wir miniage weglassen.} 
...
können weitere verfügbare Klassen angegeben sein.  \todo{MD: Klassen, die für den Einstieg empfehlenswert sind}
...
beispielsweise:
\todo{MD: Ich halte nicht soviel von verschachteltem Laden. Die Optionenübergabe fehlt völlig}
\begin{beispiel}
