...
\begin{lminipage}{10cm}
\begin{tabbing}\small
\lstinline|\textnormal|\{\textit{text}\}\qquad\=\lstinline|\normalfont|\qquad\=\kill
...
\lstinline|\texttt|\{\textit{text}\}         \>\lstinline|\ttfamily|       \>\texttt{Maschinenschrift}\\[1ex]
\lstinline|\textmd|\{\textit{text}\}         \>\lstinline|\mdseries|       \>\textmd{normal}\\
\lstinline|\textbf|\{\textit{text}\}         \>\lstinline|\bfseries|       \>\textbf{fett, breiter laufend}\\[1ex]
...
\lstinline|\textsc|\{\textit{text}\}         \>\lstinline|\scshape|        \>\textsc{Kapitälchen}\\[1ex]
...
\todo[inline,color=done]{PG: Tabelle etwas angepasst, kannste ja noch gerne ändern}
