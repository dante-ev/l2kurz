...
und in der Online-Dokumentation \cite{fntguide}\todo{PG: wenigstens XeTeX und LuaTeX mit fontspec erwähnen?\\MD: Ich denke, dem sollte ein eigener Abschnitt gewidmet werden.}.
