...
\todo{PG: eqnarray ist böse und sollte nicht verwendet werden. Besser: align. Zumindest habe ich das so in der letzten TUGboat gelesen.\\MD: Der komplette Abschnitt muss überarbeitet werden}

\todo[inline]{MD: Absatz neu}
