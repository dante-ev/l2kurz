...
\todo[inline]{PG: verstehe ich nicht:}
\todo[inline,color=green!40]{MD: So?}
...
\todo[inline]{PG: ist das Beispiel so gewollt?}
\todo[inline,color=green!40]{MD: Hatte vergessen ein \& zu entfernen.}
\begin{LTXexample}
\begin{align}
f(x) & =  \cos x       \\
f'(x) & =  -\sin x     \\
