...
(siehe Abbildung~\ref{desc}). \todo[color=done]{PG: eingefügt}Mit dem Paket \texttt{enumitem} können die Umgebungen leicht den eigenen Bedürfnissen angepasst werden.
