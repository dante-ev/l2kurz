...
notfalls auch unschön~-- vergrößert\todo{PG: microtype erwähnen?}.
...
Trennstellen\todo{PG: Stimmt nicht ganz!}.
...
Sonderzeichen enthalten\todo{PG: auch das ist nicht mehr richtig}.
...
Zeichenkombinationen gesetzt\todo{PG: csquotes erwähnen?}.
...
die Mitte der Zeile\todo{PG: ragged2e erwähnen? -> besserer Umbruch}.
...
Strich\todo{PG: booktabs mit \cs{toprule},\cs{midrule} und \cs{bottomrule} erwähnen? - macht eine schönere Tabelle}.
