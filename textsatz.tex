...
\lstinline|"~| für einen Bindestrich, an dem nicht umbrochen werden darf, 
\lstinline|"=| für einen Trennstrich, an dem ein Umbruch stattfinden darf, beispielsweise bei zusammengesetzten Hauptwörtern
und \lstinline,"|, um eine Ligatur aufzulösen, die \LaTeX{} normalerweise erzeugen würde.

\todo[inline]{PG: Das hätte ich gerne in mehreren Zeilen!}
...
\begin{LTXexample}
Er sagte \enquote{Da schrie ich
\enquote{Hallo}}
\end{LTXexample}
