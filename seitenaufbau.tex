...
zerrissen zu werden.
%%\todo[inline]{PG: mehrfache Durchläufe notwendig bei \cs{ref} und \cs{label}}
...
\todo{PG: hier funktioniert die Umgebung LTXexample nicht, weil ein float definiert wird.}
\todo[color=green]{MD: Doch, geändert. Problem sind eher die labels.}
