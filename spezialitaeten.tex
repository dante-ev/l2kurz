...
\lstinline|\begin{document}| und \lstinline|\end{document}| einen oder
...
Mit dem Befehl \lstinline|\address| definiert man die Adresse des Absenders.
\lstinline|\begin{letter}{...}| beginnt einen Brief an den im
Parameter angegebenen Empfänger.
\lstinline|\opening{...}| schreibt die Anrede 
und \lstinline|\closing{...}| den abschließenden Gruß, 
an den automatisch die eingangs mit
\lstinline|\signature| vereinbarte Unterschrift angefügt wird.
\lstinline|\end{letter}| beendet den jeweiligen Brief.
...
kennen, also auch \lstinline|\\| (sic!),
