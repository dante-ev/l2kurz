...
\end{thebibliography}
\end{LTXexample}
\todo[inline,color=done]{PG: ltxexample verschluckt das \cs{cite} :(\\MD: Sehe ich gerade :-( -- Muss ich mir was einfallen lassen\\MD: DONE}

\todo[inline,color=done]{PG: diesen Abschnitt habe ich mal eingefügt, kann aber auch wieder raus, wenn er unpassend ist.}

\todo[inline,]{MD: Absätze überarbeitet.}
